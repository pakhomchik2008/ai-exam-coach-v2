# Phase 4 decisions (index)

Full rationale lives in `docs/phase-4-plan.md`.

| # | One line |
|---|---|
| 47 | Landing tokens scoped under `.land`. App chrome unchanged. |
| 48 | No fake testimonials or fake user counts. |
