  ...
  return (
    <div style={{ borderRadius: "var(--radius-2xl)", background: "linear-gradient(135deg, var(--indigo-50), var(--indigo-50))", border: "1px solid var(--indigo-100)", padding: "var(--space-5)", display: "flex", flexDirection: "column", gap: 10 }}>
      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginTop: 4 }}>
        <button onClick={onStartReview} style={{ border: "none", background: "var(--indigo-600)", color: "var(--white)", borderRadius: "var(--radius-lg)", padding: "8px 16px", fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: "var(--font-sans)" }}>{L("Start Review", "Почати повторення", "Начать повторение", "Commencer la révision", "Wiederholung starten")}</button>
...
function MJTodaysPriority({ t, topic, onStartReview }) {
  ...
  return (
    <div style={{ borderRadius: "var(--radius-2xl)", border: `1.5px solid ${MJ_PRIORITY_COLOR[topic.priority]}33`, background: MJ_PRIORITY_BG[topic.priority], padding: "var(--space-4) var(--space-5)", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }}>
      ...
      <button onClick={onStartReview} style={{ border: "none", background: MJ_PRIORITY_COLOR[topic.priority], color: "var(--white)", borderRadius: "var(--radius-lg)", padding: "10px 22px", fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: "var(--font-sans)" }}>{L("Start Now", "Почати зараз", "Начать сейчас", "Commencer maintenant", "Jetzt starten")}</button>
    </div>
  );
}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            {retryMode === "pendingConfidence" && (
              <div style={{ borderRadius: "var(--radius-lg)", background: "var(--emerald-50)", padding: "10px 12px", display: "flex", flexDirection: "column", gap: 8 }}>
                ...
                <button onClick={confirmConfidence} style={{ alignSelf: "flex-start", border: "none", background: "var(--emerald-600)", color: "var(--white)", borderRadius: "var(--radius-lg)", padding: "6px 16px", fontSize: 12, fontWeight: 700, cursor: "pointer", fontFamily: "var(--font-sans)" }}>{L("Mark Recovered", "Позначити виправленим", "Отметить исправленным", "Marquer comme récupérée", "Als behoben markieren")}</button>
              </div>
            )}
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
              {!recovered && retryMode === "idle" && (
                <button onClick={() => setRetryMode("answering")} style={{ border: "none", background: "var(--indigo-600)", color: "var(--white)", borderRadius: "var(--radius-lg)", padding: "7px 14px", fontSize: 12, fontWeight: 700, cursor: "pointer", fontFamily: "var(--font-sans)" }}>{L("Retry", "Спробувати знову", "Повторить попытку", "Réessayer", "Erneut versuchen")}</button>
              )}
