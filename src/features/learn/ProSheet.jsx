...
export function ProSheet({ lockedCount, freeCount, onClose, t }) {
  ...
  return React.createElement("div", {
    ...
    React.createElement("p", { style: { margin: "0 0 18px", fontSize: 15, lineHeight: 1.55, color: "var(--text-muted)" } },
      L(`${freeCount} topics in the first unit are free. ${lockedCount} more unlock with Pro — 3-day trial, then $4/month. Card at checkout.`,
        `${freeCount} тем у першому юніті безкоштовно. Ще ${lockedCount} відкриються в Pro — 3 дні тріалу, далі $4/міс. Картка на Checkout.`,
        `${freeCount} тем в первом юните бесплатно. Ещё ${lockedCount} откроются в Pro — 3 дня триала, дальше $4/мес. Карта на Checkout.`,
        `${freeCount} sujets du premier chapitre sont gratuits. ${lockedCount} de plus avec Pro — 3 jours d’essai, puis $4/mois.`,
        `${freeCount} Themen der ersten Einheit gratis. ${lockedCount} weitere mit Pro — 3 Tage Trial, dann $4/Monat.`)),
