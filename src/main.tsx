 ...
 * That is deliberate for this phase: it is what makes the migration
 * behavior-preserving. Bare identifiers inside a module fall through module
 * scope to the global object, so an unconverted file calling `getProfile()`
 * still resolves to `window.getProfile` exactly as it did before. Converting
 * those to real imports is Phase 1b, one module at a time.
 */
...
// safety net. Enable it in Phase 1b once those side effects are covered by tests.
