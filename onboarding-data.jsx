...
const EXAM_TYPES = [
  ...
  { id: "sat",    label: "SAT",        emoji: "🇺🇸", blurb: "400–1600",               board: "College Board", educationSystemId: "k12",
    grade: { kind: "score", min: 400, max: 1600, step: 10, current: 1180, target: 1450 } },
  { id: "act",    label: "ACT",        emoji: "🇺🇸", blurb: "Composite 1–36",         board: "ACT, Inc.", educationSystemId: "k12",
    grade: { kind: "score", min: 1, max: 36, step: 1, current: 26, target: 32 } },
  { id: "ap",     label: "AP",         emoji: "🇺🇸", blurb: "Advanced Placement 1–5", board: "College Board", educationSystemId: "k12",
    grade: { kind: "scale", options: ["5","4","3","2","1"], current: "3", target: "5" } },
  { id: "ib",     label: "IB",         emoji: "🌍", blurb: "Diploma 1–7 / 45",        board: "Int. Baccalaureate", educationSystemId: "k12",
    grade: { kind: "scale", options: ["7","6","5","4","3","2"], current: "4", target: "6" } },
  { id: "nmt",    label: "NMT",        emoji: "🇺🇦", blurb: "НМТ · 100–200",          board: "UCEQA", educationSystemId: "k12",
    grade: { kind: "score", min: 100, max: 200, step: 1, current: 145, target: 180 } },
  { id: "matura", label: "Matura",     emoji: "🇵🇱", blurb: "0–100%",                 board: "CKE", educationSystemId: "k12",
    grade: { kind: "score", min: 0, max: 100, step: 1, suffix: "%", current: 60, target: 85 } },
  { id: "abitur", label: "Abitur",     emoji: "🇩🇪", blurb: "1.0 best → 4.0",         board: "KMK", educationSystemId: "k12",
    grade: { kind: "scale", options: ["1.0","1.3","1.7","2.0","2.3","2.7","3.0"], current: "2.3", target: "1.3" } },
  { id: "uni",    label: "University", emoji: "🎓", blurb: "Degree classifications",  board: "Custom modules", educationSystemId: "higher-ed",
    grade: { kind: "scale", options: ["1st","2:1","2:2","3rd","Pass"], current: "2:1", target: "1st" } },
  { id: "custom", label: "Custom",     emoji: "✏️", blurb: "Set your own",            board: "Any exam", educationSystemId: null,
